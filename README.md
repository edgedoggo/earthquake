...
Earthquake 3.1.5 is verified for Foundry VTT 14 while retaining runtime fallbacks for Foundry VTT 10-13. If your table needs the exact pre-v14 package, use the `v3.0.0` release instead of `latest`.
