...
Earthquake 3.1.10 is verified for Foundry VTT 14 while retaining runtime fallbacks for Foundry VTT 10-13. If your table needs the exact pre-v14 package, use the `v3.0.0` release instead of `latest`.
...
https://raw.githubusercontent.com/openkyle/earthquake/main/earthquake/module.json
...
- **Show quick menu on macro launch**: Let the GM adjust earthquake settings before shaking.
