...
Earthquake 3.1.4 is verified for Foundry VTT 14 while retaining runtime fallbacks for Foundry VTT 10-13. If your table needs the exact pre-v14 package, use the `v3.0.0` release instead of `latest`.
...
- **Prompt Before Shaking**: Ask the GM to shake now or adjust settings before the earthquake begins.
